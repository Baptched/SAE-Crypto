...
from double_sdes import crypte_double_sdes, decrypte_double_sdes, cassage_brutal, cassage_astucieux, cassage_brutal_avec_thread
...
class TestSDES(unittest.TestCase):
    ...
    def test_cassage_brutal_avec_thread(self):
        """
        Fonction permettant de tester la fonction cassage_brutal_avec_thread
        """
        message_clair = "Je m'appelle Baptiste"
        message_crypte = crypte_double_sdes(message_clair, 0b00000000,
                                            0b11100011)
        self.assertEqual(
            cassage_brutal_avec_thread(message_clair, message_crypte)[0:2],
            (0b00000000, 0b11100011))
        message_clair = "Bonjour"
        message_crypte = crypte_double_sdes(message_clair, 0b00000000,
                                            0b00000000)
